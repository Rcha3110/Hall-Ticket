...
def generate_hall_ticket(data, photo_path, qr_code_path, output_path):
    ...
    # Header
    pdf.set_fill_color(144, 238, 144)   #green bg
    ...
    pdf.image("C:/Users/user/Downloads/logo_left.jpg", 10, 5, 30)
...
# Exam timetable
    ...
    pdf.cell(40, 10, "Agent's Sign", border=1, fill=True, align='C')  # New column
    pdf.ln()
    ...
    pdf.cell(60, 10, txt="Registrar's Signature:", ln=False, align="L")
